...
import frc.robot.subsystems.HubShiftUtil.ShiftEnum;
import frc.robot.subsystems.HubShiftUtil.ShiftInfo;
...
public class HubCounter extends VirtualSubsystem {
  ...
  private final DoublePublisher timeRemaining;
  private final StringPublisher currentShift;
  ...
  public HubCounter() {
    ...
    timeRemaining = hcTable.getDoubleTopic("Timer/Time-Remaining").publish();
    currentShift = hcTable.getStringTopic("Timer/Current-Shift").publish();
    isActive = hcTable.getBooleanTopic("Timer/Active-Hub").publish();
  ...
  public void periodic() {
    ...
    timeRemaining.set(Math.ceil(shiftInfo.remainingTime()));
    currentShift.set(shiftInfo.currentShift().name());
    isActive.set(shiftActive);
